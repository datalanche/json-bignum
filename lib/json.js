...
// If true, invalid JSON numbers will be re-encoded as strings.
// e.g. 8. -> "8."
// This can happen because some JSON encoders, (notably ColdFusion < 9) strip
// trailing zeros from numbers when encoding. So, 8.0 -> 8.
...
// functions and variables.
    ...
    return function (source, reviver, _allowDuplicateProperties, _allowInvalidNumbers) {
        ...
        if (_allowInvalidNumbers !== undefined) {
            allowInvalidNumbers = _allowInvalidNumbers;
        }
